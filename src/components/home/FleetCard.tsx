...
// console.log(galleryImgs)
  ...
  return (
    <div
      className={`cursor-pointer nc-StayCard group relative bg-[#111828]  border border-neutral-100 dark:border-neutral-800 rounded-2xl overflow-hidden hover:shadow-xl transition-shadow ${className}`}
