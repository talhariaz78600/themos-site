                    ...
                    <div className="w-full mx-auto my-2">
                        <div className="flex pb-3 w-full justify-between">
                            <div className="flex-1">
                                <div
                                    className="w-2 h-2 bg-green-100 mx-auto rounded-full text-lg text-white flex items-center">
                            ...
                            <div className="w-full align-center items-center align-middle content-center flex">
                                <div
                                    className="w-full bg-green-100 rounded items-center align-middle align-center flex-1">
                                    <div
                                        className="bg-green-100 text-xs leading-none text-center text-grey-darkest rounded "
                        ...
                        <div className="flex content-center justify-between w-full my-2">
            ...
            <div
                ...
                <div className="flex flex-col sm:flex-row sm:items-center">
                    ...
                    <div className="py-4 px-4">
                        <div>
                            <span className="text-sm text-neutral-400 dark:text-neutral-400 my-2 line-clamp-1">
                                {selectedVehicle.category}
                            </span>
                            <span className="text-base font-medium my-2 block">
                                {selectedVehicle.name}
                            </span>
                        </div>
                        <span className="text-sm text-neutral-400 my-2  dark:text-neutral-400 flex items-center">
                            <FiUser size={18} />
                            <span className="px-3">
                                Seats {selectedVehicle.MaxPeople} people
                            </span>
                        </span>
                        <span className="text-sm my-2 text-neutral-400 dark:text-neutral-400 flex items-center">
                            <FiBriefcase size={18} />
                            <span className="px-3">
                                Fits {selectedVehicle.MaxLuggage} suitcases
                            </span>
                        </span>
                        <div className="w-10 border-b border-neutral-700 my-2 dark:border-neutral-700"></div>
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex justify-between text-neutral-600 dark:text-neutral-400 text-sm w-full pt-4">
                        ...
                        <span className="font-medium text-neutral-100 dark:text-neutral-100">
                            {routeData.guests}
                        </span>
                    </div>
                ...
                >
                    <div className="min-h-screen overflow-y-scroll px-1 text-center md:mx-8">
                        <Transition.Child
                            ...
                            leaveTo="opacity-0"
                        >
                            <Dialog.Overlay className="fixed inset-0 bg-[#101726] bg-opacity-40 dark:bg-opacity-40" />
                        </Transition.Child>
                            ...
                            >
                                <div className="py-2 flex flex-col items-start relative">
                                    <Dialog.Title className="flex justify-end w-full">
                                        ...
                                        <ButtonClose className = "" onClick={() => handleOpenModal()}/>
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row sm:items-center mx-3 ">
                                            ...
                                            <div className="pt-4 pb-5 sm:px-5 space-y-3">
                                                ...
                                                <span
                                                    className="text-sm text-neutral-400 dark:text-neutral-400 flex items-center">
                                                    <FiUser size={18} />
                                                    <span className="px-3">
                                                        Seats {selectedVehicle.MaxPeople} people
                                                    </span>
                                                ...
                                                <div
                                                    className="w-10 border-b border-neutral-700  dark:border-neutral-700"></div>
                                                <StartRating />
                                            </div>
                                        </div>
                                        {/* Transfer Detail */}
                                        ...
                                        {formState.pickUpTime && (
                                            <div className="relative pb-5 mb-2">
                                                <div
                                                    className="cursor-pointer text-neutral-400 dark:text-neutral-400 flex justify-center right-0">
                                                    <span className="text-md pb-2">Return</span>
                                                </div>
                                                {/*Transfer date*/}
                                                <div className="w-full text-center text-xs text-neutral-500 space-x-3">
                                        ...
                                        {/**/}
                                        <div className="border-b border-neutral-700 dark:border-neutral-700 mx-3"></div>
                                        ...
                                        <div className="space-y-1 py-4 mx-3">
                                            ...
                                            <div className="border-b border-neutral-700 dark:border-neutral-700"></div>
    ...
    const renderCashTab = () => {
        return (<div>
            <div className="w-full flex flex-col items-center justify-between">
                ...
                <div
                    className="flex items-center my-4 justify-between shadow-2xl dark:shadow-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full  px-4 py-2 space-x-2 font-light text-sm text-white">
    ...
    return (
        <>
            <div className={`nc-CheckOutPage ${className}`} data-nc-id="CheckOutPage">
                ...
                <main className="container pay-main">
                    {clientSecret && (
